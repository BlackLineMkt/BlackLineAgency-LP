...
const steps = [
  ...
  { n: "02", title: "Atração", desc: "Anúncios com linguagem do nicho que trazem o lead certo, não qualquer um." },
  { n: "03", title: "Conversão", desc: "CRM e funil que transformam lead em agendamento fechado." },
  { n: "04", title: "Otimização", desc: "Dados reais todo mês. Ajuste contínuo. Resultado crescente." },
];
    ...
    <section id="metodo" className="relative py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        <div className="reveal mx-auto max-w-3xl text-center">
          <span className="text-xs font-medium uppercase tracking-[0.22em] text-gold">O Método Black Line</span>
          ...
          <div className="grid gap-8 md:grid-cols-4 md:gap-6">
            {steps.map((s, i) => (
              <div key={s.n} className="reveal relative" style={{ transitionDelay: `${i * 80}ms` }}>
                <div className="relative z-10 mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-gold/40 bg-background font-display text-lg font-bold text-gold shadow-gold">{s.n}</div>
